...
class FaceFeatureRequestCommand(object):
    ...
    def __init__(self, destination=None, command=None, snaps=None, snap_upload_models=None):  # noqa: E501
        """FaceFeatureRequestCommand - a model defined in OpenAPI"""  # noqa: E501
